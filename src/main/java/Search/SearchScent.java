...
public class SearchScent {

    private static final  String target="SCENT";
    ...
    public static void main(String[] args){
         ...
         */
        String query= URLEncoder.encode("{\"PY\":\"2020\"}");

        /** 검색할 쿼리를 입력하여 과학향기 검색 api에 request를 요청하고 response를 받는다. */
        String response= SearchScent.getSearchResults(query);
